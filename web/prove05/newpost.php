...
<html>
    ...
    <body>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <input type="text" size="150" name="title" value="" placeholder="Enter an interesting and descriptive title" style="font-size: 16px; margin: 15px 0px 0px 30px;"><br><br>
            <textarea rows="10" cols="150" name="post" value="" placeholder="Enter post description" style="font-size: 14px; margin-left: 30px;"></textarea><br><br>
